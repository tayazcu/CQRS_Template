...
{
    public abstract class DesignTimeApplicationContextFactoryBase<TContext> : IDesignTimeDbContextFactory<TContext> where TContext : DbContext
    {
        private const string AspNetCoreEnvironment = "ASPNETCORE_ENVIRONMENT";

        public DesignTimeApplicationContextFactoryBase()
        { }

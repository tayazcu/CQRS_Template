...
namespace Project.Framework.Extensions
{
    public static class StringExtensions
    {
        ...
        public static bool HasValue(this long str)
        {
        ...
        public static bool HasValue(this string[] str)
        {
            return !str.Any() ? false : true;
        }
        public static bool HasValue(this int number)
        {
            return number <= 0 ? false : true;
        }
        public static bool HasValue(this IFormFile file)
        {
        ...
        public static bool JsonInputIsNotObject(this string value)
        {
